 ...
 */
public class DayPanel extends ImagePanel {
	...
	public DayPanel(int index1) throws IOException, ClassNotFoundException,
...
//		System.out.println("year " + yearInTitle + "month" + monthInTitle);
	...
	private void addEachDay(int year, int month) throws IOException,
		...
		for (int i = 0; i < 42; i++) {
			...
			EachDayPanel thisDayPanel = new EachDayPanel(i, s,year,month,titleBlank,endingBlank,today);
			
			dayPanel.add(thisDayPanel);
